...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ATankGameModeBase_GameStart_Statics::Function_MetaDataParams[] = {
		{ "Comment", "// need to be implemented in blueprint\n" },
		{ "ModuleRelativePath", "GameModes/TankGameModeBase.h" },
		{ "ToolTip", "need to be implemented in blueprint" },
	};
#endif
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ATankGameModeBase_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ATankGameModeBase_GameOver, "GameOver" }, // 2062794421
		{ &Z_Construct_UFunction_ATankGameModeBase_GameStart, "GameStart" }, // 1826987218
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_ATankGameModeBase_Statics::NewProp_StartDelay = { "StartDelay", nullptr, (EPropertyFlags)0x0040000000010015, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ATankGameModeBase, StartDelay), METADATA_PARAMS(Z_Construct_UClass_ATankGameModeBase_Statics::NewProp_StartDelay_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ATankGameModeBase_Statics::NewProp_StartDelay_MetaData)) };
	...
	IMPLEMENT_CLASS(ATankGameModeBase, 1306313677);
