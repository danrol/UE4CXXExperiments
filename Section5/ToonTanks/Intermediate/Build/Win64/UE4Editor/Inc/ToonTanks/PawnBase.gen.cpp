...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_APawnBase_Statics::NewProp_BaseMesh_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "Components" },
		{ "Comment", "// will be used for collisions\n" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Pawns/PawnBase.h" },
		{ "ToolTip", "will be used for collisions" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_APawnBase_Statics::NewProp_CapsuleComp_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "Components" },
		{ "Comment", "// AllowPrivateAccess = \"true\" allows to private variables to be exposed via blueprint\n" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Pawns/PawnBase.h" },
		{ "ToolTip", "AllowPrivateAccess = \"true\" allows to private variables to be exposed via blueprint" },
	};
#endif
	...
	IMPLEMENT_CLASS(APawnBase, 2005725879);
