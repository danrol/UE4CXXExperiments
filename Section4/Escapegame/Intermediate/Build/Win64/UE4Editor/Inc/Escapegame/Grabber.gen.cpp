...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UGrabber_Statics::NewProp_Reach_MetaData[] = {
		{ "Category", "Grabber" },
		{ "Comment", "// set it to null ptr so we will be able to check if value is set\n" },
		{ "ModuleRelativePath", "Grabber.h" },
		{ "ToolTip", "set it to null ptr so we will be able to check if value is set" },
	};
#endif
	...
	IMPLEMENT_CLASS(UGrabber, 1972596943);
